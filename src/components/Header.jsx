const Header = () => {
  return (
    <div className="w-full h-140  flex justify-center items-center  ">
      ...
      >
        <h1 className="text-6xl text-white font-extrabold text-center space-y-2 mt-5">Discover your next cullinary<br></br> adventure</h1>
        <p className="text-center mt-5">Explore thousands of recipes, personalized just for you. From quick weeknight dinners to gourmet<br></br> weekend feasts, find your perfect dish</p>
<div className="relative w-[600px] h-12 mt-5">
  <input
    type="search"
  ...
  />
  <button
    className="w-20 h-10 bg-amber-500  text-white absolute top-1/2 transform -translate-y-1/2 right-2 rounded-xl"
  >
    Search
  </button>
</div>
